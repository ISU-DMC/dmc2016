...
write.csv(data.frame(Features = rownames(d), Usage = d, row.names = NULL), file = "keguoh_C50_v05.csv")
# summary(fit)
...
write.csv(data.frame(Features = rownames(d.w), Usage = d.w, row.names = NULL), file = "keguoh_C50_winnow_v05.csv")
# summary(fit.w)
...
write.csv(data.frame(Features = rownames(d.f), Usage = d.f, row.names = NULL), file = "keguoh_C50_fuzzy_v05.csv")
# summary(fit.f)
...
write.csv(data.frame(Features = rownames(d.Rule.f), Usage = d.Rule.f, row.names = NULL), file = "keguoh_Rule_fuzzy_v05.csv")
# summary(fit.Rule.f)
...
write.csv(data.frame(Features = rownames(d.20.f), Usage = d.f.20, row.names = NULL), file = "keguoh_C50_fuzzy_20trials_v05.csv")
# summary(fit.20.f)
...
write.csv(data.frame(Features = rownames(d.f.5lvl), Usage = d.f.5lvl, row.names = NULL), file = "keguoh_C50_fuzzy5level_v05.csv")
# summary(fit.f.5lvl)
p.f.5lvl.bin <- p.f.5lvl
p.f.5lvl.bin[p.f.5lvl != 0] <- 1
1- sum(p.f.5lvl.bin == tst[, 1]) / length(p.f.5lvl.bin)
write.csv(data.frame(binary = p.f.5lvl.bin, row.names = NULL), file = "keguoh_C50.csv", row.names = FALSE)
...
write.csv(data.frame(Features = rownames(d.fw.5lvl), Usage = d.fw.5lvl, row.names = NULL), file = "keguoh_C50_fuzzywinnow5level_v05.csv")
# summary(fit.fw.5lvl)
...
write.csv(data.frame(Features = rownames(d.20.f.5lvl), Usage = d.20.f.5lvl, row.names = NULL), file = "keguoh_C50_fuzzy5level_20trials_v05.csv")
